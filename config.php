<?php
    ...
    $MODULES = array(/*"slowcontrol", "alarms",*/ "infopage", "graph", "download", "wiki", "chart");
...
*/
    ...
    $ADEI_CACHE = array (
    array("min" => 31536000, "res" => 432000), /* year - 12 hour data, 730 points min */
    array("min" => 31536000, "res" => 108000), 
    array("min" => 31536000, "res" => 27000), 
	array("min" => 31536000, "res" => 43200), /* year - 12 hour data, 730 points min */
	array("min" => 31536000, "res" => 10800),
